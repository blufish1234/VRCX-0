...
import { convertFileUrlToImageUrl, getNameColour, userImage } from './entityMedia';
...
describe('entityMedia', () => {
    it('converts VRChat file URLs to image URLs with endpoint normalization', () => {
        ...
        expect(convertFileUrlToImageUrl('https://images.example/avatar.png')).toBe(
    ...
    it('keeps deterministic name colors for light and dark mode', () => {
        expect(getNameColour('usr_00000000-0000-0000-0000-000000000001', false)).toBe(
            '#4400b3'
        );
        expect(getNameColour('usr_00000000-0000-0000-0000-000000000001', true)).toBe(
            '#a066ff'
        );
