...
pub fn app__get_vrchat_moderations(
    ...
    moderation::get_vrchat_moderations(&current_user_id)
}
...
pub fn app__get_vrchat_user_moderation(
    ...
    require_host_capability(HostCapability::VrchatPathDiscovery)?;
    moderation::get_vrchat_user_moderation(&current_user_id, &user_id)
}
...
pub fn app__set_vrchat_user_moderation(
    ...
    require_host_capability(HostCapability::VrchatPathDiscovery)?;
    moderation::set_vrchat_user_moderation(&current_user_id, &user_id, moderation_type)
}
